          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                Center(child: Image.asset('assets/images/badge.png', width: 160, height: 160)),
                const SizedBox(height: 16),
                Center(
                  child: Text(
                ...
                Center(
                  child: Text(
                    ...
                    style: TextStyle(fontFamily: 'Quicksand', fontSize: Responsive.text(context, size: 20), fontWeight: FontWeight.w500, color: AppColors.textPrimary),
                  ),
                ),
                // score
                Center(
                  child: Text(
                    'You\'ve mastered',
                    style: TextStyle(fontFamily: 'Quicksand', fontSize: Responsive.text(context, size: 14), color: AppColors.textPrimary),
                  ),
                ),
                Center(
                  child: Text(
                    '$percentage%',
                    style: TextStyle(fontFamily: 'Nunito', fontSize: Responsive.text(context, size: 28), fontWeight: FontWeight.bold, color: AppColors.textPrimary),
                  ),
                ),
                const SizedBox(height: 16),
                // stats row
...
class _ResultCard extends StatelessWidget {
  ...
  const _ResultCard({required this.index, required this.question, required this.definition, required this.isCorrect});

  @override
  Widget build(BuildContext context) {
    final bgColor = isCorrect ? Colors.green.withValues(alpha: 0.15) : Colors.red.withValues(alpha: 0.15);
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: AppColors.backgroundBox, borderRadius: BorderRadius.circular(12)),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(
                  'Question',
                  style: TextStyle(fontFamily: 'Nunito', fontWeight: FontWeight.w500, fontSize: Responsive.text(context, size: 12), color: AppColors.grey),
                ),
                const SizedBox(height: 4),
                Text(
                  question,
                  style: TextStyle(fontFamily: 'Quicksand', fontWeight: FontWeight.w500, fontSize: Responsive.text(context, size: 14), color: AppColors.textPrimary),
                ),
              ],
            ),
          ),
